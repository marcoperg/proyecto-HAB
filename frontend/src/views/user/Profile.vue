<template>
	<div class="profile">
		<vue-headful v-if="lang === 'en'" title="Profile | Lastorder" description="Home page of hackamarket" />
		<vue-headful v-if="lang === 'es'" title="Perfil | Lastorder" description="Home page of hackamarket" />
		<vue-headful v-if="lang === 'gl'" title="Perfil | Lastorder" description="Home page of hackamarket" />
